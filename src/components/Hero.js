        ...
        <div className="md:col-span-7 space-y-8 reveal-on-scroll">
          <div>
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl leading-relaxed">
              Business Development Intern at LynkiD | President of MC and Fashion Club | Deputy Youth Union Secretary at Foreign Trade University | Co-founder of DIAS Fashion Club.
            </p>
          </div>
